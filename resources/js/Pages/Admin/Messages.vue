            ...
            <div class="overflow-hidden">
                ...
                <div id="accordion-collapse" data-accordion="collapse" v-for="property in properties" :key="property.id">
                    <div v-if="property.messages.length">
                        ...
                        <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-[#4d1635] border border-b-0 border-[#4d1635] rounded-t-xl hover:bg-gray-100 " :data-accordion-target="'#accordion-collapse-body-'+property.id" aria-expanded="false" :aria-controls="'accordion-collapse-body-'+property.id">
