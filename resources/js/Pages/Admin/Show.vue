...
<template>
    <section class="">
        <main class="container mx-auto w-5/6">
            ...
            >
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                    <div class="duration-200 ease-linear" data-carousel-item>
                        <img
                            src="https://aff.bstatic.com/images/hotel/840x460/261/261020602.jpg"
                    ...
                    >
                        <img
                            src="https://aff.bstatic.com/images/hotel/840x460/261/261020461.jpg"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                            alt="..."
                        />
                    </div>
                    ...
                    >
                        <img
                            src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/365453242.jpg?k=2e992b99e0e329cec1e52f486a044b0bf8adea19aa5049e1cf393fa82b52274c&o=&hp=1"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                            alt="..."
                        />
                    </div>
                    ...
                    >
                        <img
                            src="https://www.arteincasamia.it/site/assets/files/1781/placeholder.png"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                            alt="..."
                        />
                    </div>
            ...
            <div class="flex ml-4">
                <div
                    class="flex-end flex flex-wrap border-[#4d1635] rounded-md m-1 w-1/3 p-6"
                >
                    <ul
                    ...
                    <ul
                        class="w-48 ml-6 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    >
                        <li
                            class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600"
                        >
                ...
                <div
                    class="flex-end border-[#4d1635] border-2 rounded-md m-1 w-1/3 p-6"
                >
                    <h4>Recensioni</h4>
                </div>
            </div>
