                ...
                <div class="flex justify-between w-full">
                    ...
                    <div class="mb-4">
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" value="" class="sr-only peer" @click="newProperty.is_visible = !newProperty.is_visible">
                            ...
                            <span v-if="newProperty.is_visible" class="ml-3 text-sm font-bold text-green-600">Pubblico</span>
                            <span v-else class="ml-3 text-sm font-bold text-yellow-600">Privato</span>
                        </label>
                    </div>
