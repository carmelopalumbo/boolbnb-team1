    ...
    <Header />
        <main class="ofc">
            ...
            <div class="flex flex-col">
                <div class="mx-auto space-x-6 h-5/6 w-5/6 mt-3 flex md:flex-row flex-col columns-3 justify-between ">

                <div class=" w-1/2 hover:scale-105 transition duration-300 rounded-md border-[#4d1635] border-2 ">
