...
<template>
    <section class="footer-bottom-fix">
        <footer
            class="w-full p-4 bg-white dark:text-white dark:bg-[#111111] border-t shadow flex md:items-center justify-between flex-row md:p-6"
        >
            <span
                class="text-sm text-gray-800 dark:text-white sm:text-center hidden md:inline-block"
                >© 2023 BoolBnB Team1. All Rights Reserved. |
                <span class="text-sm dark:text-white text-gray-800 sm:text-center"
