...
<template>
    <div
        class="group container flex justify-center max-w-sm items-center bg-white border-2 rounded-xl border-[#4d1635] m-5 content-div"
    >
        <div class="image-cover">
            <!-- <img class="rounded-t-lg group-hover:opacity-25" src="http://[::1]:5173/storage/app/public/uploads/EANf81bSGpqKbxHaF1Bnb8hvdb3Ui6Pp4FIo9S7X.png" alt="" /> -->
        </div>

        <div class="p-5 group-hover:opacity-25 text-white">
            <h5 class="text-2xl font-bold tracking-tight uppercase">
                {{ property.name }}
            </h5>
            <div class="text-xs mb-2">{{ property.address }}</div>
            <p class="mb-3 font-normal text-white text-bold">
